    ...
    <header class="site-navbar py-4 js-sticky-header site-navbar-target" role="banner">
      ...
      <div class="container-fluid">
        <div class="d-flex align-items-center">
          <div class="site-logo"><a href="index.php">Stamina<span>.</span> </a></div>
          <div class="ml-auto">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                <li><a href="index.php#home-section" class="nav-link">Home</a></li>
                <li><a href="index.php#classes-section" class="nav-link active">Classes</a></li>
                <li><a href="index.php#schedule-section" class="nav-link">Schedule</a></li>
                <li><a href="index.php#trainer-section" class="nav-link">Trainer</a></li>
